...
#property description "Regular Trading Bot - Mean Reversion Strategy"
...
input double   InpMaxLossPerTrade = 0.02;     // Max loss per trade (2%)
input double   InpMaxDailyLoss = 0.05;        // Max daily loss (5%)
input double   InpMaxOverallLoss = 0.10;      // Max overall loss (10%)
...
input int      InpMagicNumber = 234001;       // Magic number for orders
...
int OnInit()
{
    ...
    Print("✅ Regular Bot initialized successfully");
...
{
    Print("🔚 Regular Bot deinitialized. Reason: ", reason);
}
